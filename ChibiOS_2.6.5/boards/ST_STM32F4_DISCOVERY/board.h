 ...
 * PD2  - PIN2                      (output pushpull maximum).
 * PD3  - PIN3                      (output pushpull maximum).
 * PD4  - RESET                     (output pushpull maximum).
 * PD5  - OVER_CURRENT              (input floating).
 * PD6  - PIN6                      (output pushpull maximum).
 * PD7  - PIN7                      (output pushpull maximum).
 * PD8  - PIN8                      (output pushpull maximum).
 * PD9  - PIN9                      (output pushpull maximum).
 * PD10 - PIN10                     (output pushpull maximum).
...
#define VAL_GPIOD_PUPDR             (PIN_PUPDR_PULLDOWN(GPIOD_PIN0) |         \
                                     ...
                                     PIN_PUPDR_PULLDOWN(GPIOD_RESET) |      \
