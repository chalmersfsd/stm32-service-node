...
static THD_WORKING_AREA(steeringSafetyThreadWA, 64);
/*
...
/*
  chThdCreateStatic(steeringSafetyThreadWA, sizeof(steeringSafetyThreadWA), NORMALPRIO, steeringSafetyFunction, NULL);
*/
